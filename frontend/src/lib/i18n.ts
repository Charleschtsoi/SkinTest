...
import type { FindingLabel, SkinNoticeKind } from "@/types";
...
const dictEn: Dict = {
  ...
  "landing.hero.badge": "Smartphone skin screening companion",
  "landing.hero.title": "Check your skin photo",
  "landing.hero.subtitle": "Take a clear photo of a mole or lesion with your phone. Get educational AI feedback on patterns that may warrant dermatologist review.",
  "landing.hero.ctaUpload": "Take or upload a photo",
  "landing.hero.ctaLearn": "Learn about skin screening",
  "landing.hero.trust": "Images are sent securely to our API for analysis — never used for advertising",
  "landing.how.title": "How it works",
  "landing.how.subtitle": "Three simple steps from phone photo to clearer understanding.",
  "landing.how.step1.title": "Take a clear photo",
  "landing.how.step1.body": "Use good lighting and fill the frame with one mole or lesion. Avoid blur and shadows when possible.",
  "landing.how.step2.title": "Upload for educational analysis",
  "landing.how.step2.body": "Upload your JPEG or PNG for plain-language guidance on melanoma, BCC, and benign nevus patterns — not a diagnosis.",
  "landing.how.step3.title": "Review findings & AI summary",
  "landing.how.step3.body": "See model scores, attention maps, and a Gemini educator summary to discuss with your dermatologist.",
  ...
  "landing.expect.does.1": "Explain skin lesion terms (melanoma, BCC, nevus) in plain language",
  "landing.expect.does.2": "Show where an educational model focuses attention on your photo",
  "landing.expect.does.3": "Summarize patterns in an easy-to-read AI educator card",
  "landing.expect.does.4": "Support health literacy for smartphone skin screening",
  "landing.expect.not.1": "Confirm you have skin cancer or any specific diagnosis",
  ...
  "landing.disclaimer.p2": "If a mole is rapidly changing, bleeding, painful, or you notice a new concerning lesion or spreading rash, seek medical care promptly rather than relying on this website.",
  "upload.title": "Take or upload your skin photo",
  "upload.subtitle": "Upload a smartphone photo of a mole or lesion to begin screening.",
  "upload.step1": "Privacy & disclaimer",
  "upload.step2": "Take or upload photo",
  ...
  "upload.privacy.next": "Continue to photo upload",
  "upload.dicom.title": "Supported image formats",
  "upload.dicom.desc":
    "Upload JPEG, PNG, or WEBP files. Maximum file size: 10MB.",
  "upload.drop.prompt": "Drag & drop or tap to choose a photo",
  ...
  "upload.pipeline.model2": "Running Model 2 (ResNet-152V2) skin lesion analysis...",
  ...
  "densenet.label.normal": "Benign Nevus",
  ...
  "results.subtitle": "Explore your photo, attention map, and skin findings — then discuss with your dermatologist.",
  ...
  "results.llmFailedHint": "When this appears, the backend usually could not complete the Gemini call (invalid key, quota, model error, or network). Check Google AI Studio if you use BYOK.",
  "results.llmSkippedHint": "Optional: add a Gemini API key on the upload step so the educator summary can run (BYOK).",
  ...
  "results.tab.xray": "Your photo",
  "results.tab.attention": "AI Attention Maps",
  "results.attention.cardTitle": "Lesion heatmap analysis",
  "results.attention.cardDescription": "Grad-CAM overlays show where convolutional models focused on the lesion area. Educational only — not a diagnosis.",
  ...
  "results.attention.edu.purposeBody": "This helps confirm the model is focusing on your skin lesion rather than background, jewelry, or ruler marks. You and your dermatologist can discuss what the AI highlighted together.",
  ...
  "results.anatomyPlaceholder": "Typical positions for skin lesion labels (educational schematic).",
  "results.anatomyHeader": "What the AI noticed",
  "results.anatomySub": "Educational model scores — not a diagnosis. Only a dermatologist can confirm what your photo shows.",
  "results.noSignificant": "The AI did not highlight any significant patterns. Changing moles should still be reviewed by a clinician.",
  ...
  "results.provenance.hybridBanner.bothModels": "Models 1 and 2 used live classifiers on this run. The attention overlay and some report text may still use rule-based scaffolding.",
  "results.provenance.hybridBanner.model1Only": "Model 1 used a live classifier. Model 2 did not run as a loaded neural model on this run. Findings and attention overlay may include rule-based scaffolding.",
  "results.provenance.hybridBanner.model2Only": "Model 2 ran on this upload. Model 1 did not run as a loaded classifier. Findings and attention overlay may include rule-based scaffolding.",
  "results.provenance.hybridBanner.fallback": "This run mixed live and non-live sources. Check the pipeline badges for which steps used a model, rules, LLM, or static educational content.",
  ...
  "stage.Normal": "Benign / normal appearance",
  "stage.Other": "Other",
  "risk.low": "low",
  "risk.medium": "medium",
  "risk.high": "high",
  ...
  "learn.title": "Learn about skin screening",
  "learn.topicPrefix": "Learn:",
  "learn.desc": "Educational hub for skin lesion vocabulary and how to read your report — without replacing your dermatologist.",
  "learn.topicDesc":
  ...
  "about.title": "Built to make skin screening education accessible",
  "about.subtitle": "SkinTest helps people understand smartphone skin photos in plain language. The focus is health literacy — not replacing professional care.",
  ...
  "about.stackModel": "Model: PyTorch vision ensemble trained on skin lesion datasets",
  ...
  "upload.capture.tipsTitle": "Tips for a good photo",
  "upload.capture.tip1": "Use bright, even lighting",
  "upload.capture.tip2": "Fill the frame with one lesion",
  "upload.capture.tip3": "Hold steady to avoid blur",
  "upload.capture.takePhoto": "Take photo",
  "upload.capture.chooseGallery": "Choose from gallery",
  "stage.Melanoma": "Melanoma",
  "stage.Basal Cell Carcinoma": "Basal cell carcinoma",
  "stage.Benign Nevus": "Benign nevus",
};
...
const dictHant: Dict = {
  ...
  "footer.copy": "僅供教育用途",
  "landing.hero.badge": "智慧型手機皮膚篩檢夥伴",
  "landing.hero.title": "檢視你的皮膚照片",
  "landing.hero.subtitle": "用手機清楚拍攝痣或病灶，取得教育性 AI 回饋，了解是否值得請皮膚科醫師覆檢。",
  "landing.hero.ctaUpload": "拍攝或上傳照片",
  "landing.hero.ctaLearn": "了解皮膚篩檢",
  "landing.hero.trust": "影像會安全傳送至我們的 API 進行分析，絕不用於廣告",
  "landing.how.title": "如何使用",
  "landing.how.subtitle": "從手機照片到更易理解的結果，只需三個步驟。",
  "landing.how.step1.title": "拍攝清楚照片",
  "landing.how.step1.body": "光線充足，讓單一痣或病灶填滿畫面，盡量避免模糊與陰影。",
  "landing.how.step2.title": "上傳進行教育性分析",
  "landing.how.step2.body": "上傳 JPEG 或 PNG，以淺白語言了解黑色素瘤、基底細胞癌與良性痣等模式 — 並非診斷。",
  "landing.how.step3.title": "檢視發現與 AI 摘要",
  "landing.how.step3.body": "查看模型分數、注意力圖與 Gemini 教育摘要，再與皮膚科醫師討論。",
  "landing.how.step": "步驟",
  "landing.expect.title": "先釐清定位",
  "landing.expect.subtitle": "清楚區分教育用途與醫療決策。",
  "landing.expect.does": "本工具會做什麼",
  "landing.expect.not": "本工具不會做什麼",
  "landing.expect.does.1": "以淺白語言解釋皮膚病灶術語（黑色素瘤、BCC、痣）",
  "landing.expect.does.2": "顯示教育性模型在照片上關注的區域",
  "landing.expect.does.3": "以易讀的 AI 教育卡片摘要模式",
  "landing.expect.does.4": "支援智慧型手機皮膚篩檢的健康素養",
  "landing.expect.not.1": "確認你是否患有皮膚癌或任何特定診斷",
  ...
  "landing.disclaimer.p2": "若痣快速變化、出血、疼痛，或出現新的可疑病灶或擴散性皮疹，請盡快就醫，勿僅依賴本網站。",
  "upload.title": "拍攝或上傳皮膚照片",
  "upload.subtitle": "上傳手機拍攝的痣或病灶照片以開始篩檢。",
  "upload.step1": "隱私與免責聲明",
  "upload.step2": "拍攝或上傳照片",
  ...
  "upload.pipeline.model2": "執行 Model 2（ResNet-152V2）皮膚病灶分析…",
  ...
  "densenet.alt.preview": "已上傳皮膚照片預覽",
  ...
  "results.subtitle": "檢視照片、注意力圖與皮膚發現，再與皮膚科醫師討論。",
  ...
  "results.llmHowGeneratedBodyHans":
    "此区块由服务器端的大型语言模型（LLM）将模型输出与教育语境整理成较易读的文字，仅供学习参考：不作疾病诊断、不保证身体状况，也不能替代医师或皮膚科医生。影像解读请务必与医护团队讨论。",
  "results.pdfSection.visualXray": "皮膚照片視覺分析",
  ...
  "results.tab.xray": "你的照片",
  "results.tab.attention": "AI 注意力熱圖",
  "results.attention.cardTitle": "病灶熱力圖分析",
  "results.attention.cardDescription": "Grad-CAM 疊圖顯示卷積模型在病灶區域的關注點。僅供教育 — 並非診斷。",
  ...
  "results.anatomyPlaceholder": "標準 PA 皮膚照片的常見標記位置（教育示意）。",
  "results.anatomyHeader": "AI 注意到的內容",
  "results.anatomySub": "教育性模型分數 — 並非診斷。僅皮膚科醫師能確認照片所示。",
  "results.noSignificant": "AI 未標示顯著模式。變化中的痣仍應由醫師覆檢。",
  ...
  "results.provenance.hybridBanner.model1Only":
    "模型 1 使用即時分類模型。模型 2 此輪未以已載入的神經模型執行。發現區塊與關注圖仍可能包含規則型教育內容。",
  "results.provenance.hybridBanner.model2Only":
    "模型 2 已執行。模型 1 此輪未以已載入的分類模型執行。發現區塊與關注圖仍可能包含規則型教育內容。",
  ...
  "about.title": "讓皮膚篩檢教育更普及",
  "about.subtitle":
    "SkinTest 是皮膚照片分析與教育工具，目標是以淺白方式幫助使用者理解影像結果，提升健康素養，而非取代專業醫療判斷。",
  ...
  "about.email": "電郵聯絡",
  "about.linkedin": "LinkedIn",
  "upload.capture.tipsTitle": "拍攝小提示",
  "upload.capture.tip1": "光線明亮、均勻",
  "upload.capture.tip2": "畫面以單一病灶為主",
  "upload.capture.tip3": "持穩避免模糊",
  "upload.capture.takePhoto": "拍攝照片",
  "upload.capture.chooseGallery": "從相簿選擇",
  "stage.Melanoma": "黑色素瘤",
  "stage.Basal Cell Carcinoma": "基底細胞癌",
  "stage.Benign Nevus": "良性痣",
};
...
const dictHans: Dict = {
  ...
  "footer.copy": "仅供教育用途",
  "landing.hero.title": "查看你的皮肤照片",
  "landing.hero.subtitle": "用手机清晰拍摄痣或病灶，获取教育性 AI 反馈，了解是否值得请皮肤科医生复检。",
  "landing.how.title": "如何使用",
  "landing.expect.title": "先明确定位",
  "landing.explore.aria": "更多关于 SkinTest",
  "landing.disclaimer.title": "医疗免责声明",
  "upload.title": "拍摄或上传皮肤照片",
  "upload.subtitle": "上传手机拍摄的痣或病灶照片以开始筛查。",
  "upload.step1": "隐私与免责声明",
  ...
  "upload.pipeline.model2": "执行 Model 2（ResNet-152V2）皮肤病灶分析…",
  ...
  "densenet.alt.preview": "已上传皮膚照片预览",
  ...
  "results.subtitle": "查看照片、注意力图与皮肤发现，再与皮肤科医生讨论。",
  ...
  "results.llmHowGeneratedBodyHans":
    "此区块由服务器端的大型语言模型（LLM）将模型输出与教育语境整理成较易读的文字，仅供学习参考：不作疾病诊断、不保证身体状况，也不能替代医师或皮膚科医生。影像解读请务必与医护团队讨论。",
  "results.pdfSection.visualXray": "皮肤照片视觉分析",
  ...
  "results.attention.cardTitle": "病灶热力图分析",
  "results.attention.cardDescription": "Grad-CAM 叠图显示卷积模型在病灶区域的关注点。仅供教育 — 并非诊断。",
  "results.attention.overlayBadge": "模型 1 — ResNet-50 注意力",
  "results.attention.overlayBadgeModel3": "模型 3 — DenseNet-121 注意力",
  ...
  "results.noSignificant": "AI 未标示显著模式。变化中的痣仍应由医师复检。",
  "results.sticky":
  ...
  "results.provenance.hybridBanner.model1Only":
    "模型 1 使用实时分类模型。模型 2 本轮未以已加载的神经网络模型运行。发现板块与关注图仍可能包含基于规则的教育内容。",
  "results.provenance.hybridBanner.model2Only":
    "模型 2 已运行。模型 1 本轮未以已加载的分类模型运行。发现板块与关注图仍可能包含基于规则的教育内容。",
  "results.provenance.hybridBanner.fallback":
  ...
  "upload.capture.tipsTitle": "拍摄小提示",
  "upload.capture.tip1": "光线明亮、均匀",
  "upload.capture.tip2": "画面以单一病灶为主",
  "upload.capture.tip3": "持稳避免模糊",
  "upload.capture.takePhoto": "拍摄照片",
  "upload.capture.chooseGallery": "从相册选择",
  "stage.Melanoma": "黑色素瘤",
  "stage.Basal Cell Carcinoma": "基底细胞癌",
  "stage.Benign Nevus": "良性痣",
};
